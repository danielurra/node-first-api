...
We never use a simple file in a **real world** scenario, we use Databases instead, here and for educational purposes only we are making use of a simple file<br>
